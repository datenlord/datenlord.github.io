const s="/zh/assets/image1-c9ed2270.png",e=[s],a={label:"Rust实现K8S调度扩展",description:"K8S调度器(kube-scheduler)是K8S调度pod的控制器，它作为K8S核心组件运行。调度器基于一定的调度策略为pod找到合适的运行节点。",location:"河南",author:["潘政"],tags:["Rust"],date:"2022-05-27",title:"Rust Implementation of K8S Scheduling Extensions"},o=[{label:"背景介绍",level:2},{label:"调度流程",level:3},{label:"调度算法",level:3},{label:"调度扩展",level:2},{label:"数据结构",level:3},{label:"调度扩展 Web 服务",level:3},{label:"总结",level:2}],l=`<h2 id="背景介绍">背景介绍</h2>
