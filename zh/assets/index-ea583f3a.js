const t="/datenlord.github.io/zh/assets/cover-78606c04.png",s="/datenlord.github.io/zh/assets/image1-f46bfcc6.jpg",o=[t,s],n={label:"Rust X Datenlord：第二届中国Rust开发者大会回顾",description:"达坦科技自成立以来积极探索软硬件深度融合，专注于打造新一代的开源跨云存储平台，以满足不同行业客户对数据跨云、跨数据中心高性能访问的需求。",cover:"./cover.png",location:"新加坡",date:"2022-08-04",title:"Rust X Datenlord: Review of the Second China Rust Developer Conference"},e=[{label:"专题演讲",level:2},{label:"线上 workshop",level:2},{label:"参与我们",level:2}],r=`<p><img src="${t}" alt="封面"></p>
...
<p><img src="${s}" alt="封面"></p>`;export{o as assetURLs,r as default,n as metadata,e as toc};
