const o="/zh-cn/assets/cover-9c53ea5f.png",r="/zh-cn/assets/image1-27d3eac6.jpg",t=[o,r],p={label:"相约这个夏天｜达坦科技邀您参加2023开源之夏",description:"开源之夏（英文简称“OSPP”）是中科院软件所“开源软件供应链点亮计划”指导下的系列暑期活动。达坦科技自开源之夏创办首期起每年参与，积极鼓励在校学生积极参与开源软件的开发维护，培养和发掘更多优秀的开发者。今年，DatenLord一如既往带着对开源的热忱与初心，携旗下软硬件开源项目第四次参与开源之夏。",cover:"./cover.png",location:"中国香港",date:"2023-05-04",title:"Meet this summer｜Datan Technology invites you to participate in the 2023 Open Source Summer"},s=[{label:"开源之夏为什么值得参加？",level:2},{label:"DatenLord 项目列表",level:2},{label:"项目一",level:3},{label:"项目二",level:3},{label:"项目三",level:3},{label:"项目四",level:3},{label:"项目五",level:3},{label:"项目六",level:3},{label:"项目七",level:3},{label:"项目八",level:3},{label:"开源之夏 DatenLord 项目往期获奖学生感言",level:2},{label:"活动日程",level:2}],n=`<h2 id="开源之夏为什么值得参加？">开源之夏为什么值得参加？</h2>
<ul>
...
<p>“开源之夏”活动在众多的开源项目与高校学生之间搭建了一座桥梁。同学们通过参与“开源之夏”的活动，在开源项目导师的指导下，不但可以丰富项目实践经验，提升项目开发的技能，而且可以与开源项目的开发者进行深度的交流，以一种最直接的方式了解开源，深入开源，为后续的学业方向提供参考，职业发展积累人脉。<strong>欢迎各位同学热情参与体验 DatenLord 的开源之夏项目！</strong></p>`;export{t as assetURLs,n as default,p as metadata,s as toc};
