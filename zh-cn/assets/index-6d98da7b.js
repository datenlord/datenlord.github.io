const t="/zh-cn/assets/cover-5856255d.png",s="/zh-cn/assets/image1-a156153e.png",o="/zh-cn/assets/image2-b0a4a464.png",n="/zh-cn/assets/image2-bf4f8777.png",r="/zh-cn/assets/image-d0c27c17.png",a=[t,s,o,n,r],e={label:"2024 RISC-V中国峰会同期活动预告 l 硬件敏捷开发与验证方法学研讨会",description:"2024 RISC-V 中国峰会将于8月19日至25日在杭州黄龙饭店隆重举行。峰会采用“主会议+技术研讨会+展览展示+同期活动”的创新形式，将有超过20场同期活动在8月19日至25日期间同步进行。RISC-V 中国峰会至今已成功举办四届，现已成为中国大陆规格最高、规模最大、影响力最强的专业会议之一。作为本届RISC-V中国峰会的同期活动，8月22日上午，达坦科技将举办第三届硬件敏捷开发与验证方法学研讨会。",cover:"./cover.png",location:"新疆",date:"2024-08-16",title:"RISC V China Summit Simultaneous Event Preview l Hardware Agile Development and Verification Methodology Seminar"},g=[{label:"活动信息",level:2}],i=`<p><img src="${t}" alt="图片">
...
<img src="${r}" alt="图片"></p>`;export{a as assetURLs,i as default,e as metadata,g as toc};
