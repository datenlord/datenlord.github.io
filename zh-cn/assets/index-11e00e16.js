const e="/zh-cn/assets/cover-4f6768e5.png",n=[e],c={label:"Xline社区会议Call Up｜在 CURP 算法中实现联合共识的安全性",description:"为了更全面地向大家介绍Xline的进展，同时促进Xline社区的发展，我们将于2024年5月31日北京时间11:00 p.m.召开Xline社区会议。",cover:"./cover.png",location:"中国香港",date:"2024-05-23",title:"Xline Community Meeting Call Up Securing Joint Consensus in CURP Algorithm"},i=[{label:"社区会议主题",level:2},{label:"会议摘要",level:2},{label:"欢迎参与到 Xline 项目中：",level:2},{label:"目前 Xline 提供如下 Good First Issue：",level:2},{label:"Xline 近期文章参考：",level:2}],t=`<p><img src="${e}" alt="图片"></p>
<p>为了更全面地向大家介绍 Xline 的进展，同时促进 Xline 社区的发展，我们将于 <strong>2024 年 5 月 31 日北京时间 11:00 p.m.</strong> 召开 <strong>Xline 社区会议</strong>。</p>
...
在 Xline 的 CURP 系统中，本文深入探讨了 RIFL 作为基础设施，为 RPC 提供 Exactly-Once 语义的实现及相关问题的解决方案</p>`;export{n as assetURLs,t as default,c as metadata,i as toc};
