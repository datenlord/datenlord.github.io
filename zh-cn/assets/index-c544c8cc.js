const p="/zh-cn/assets/cover-39643179.png",e="/zh-cn/assets/image1-a93ba076.jpg",t="/zh-cn/assets/image2-4624885a.gif",a="/zh-cn/assets/image3-ea54df7e.jpg",s=[p,e,t,a],l={label:"直播预告 | RDMA软件接口高层封装",description:"RDMA 作为高速通信协议被数据中心广泛使用，但是因为底层接口设计得过于繁复，对使用者造成了很大的不便，因此我们使用 Rust 语言对 RDMA 进行了一层高层封装。这次分享将介绍这层封装的做法和原理。",cover:"./cover.png",location:"香港",date:"2022-05-17",title:"RDMA Software Interface High Level Package"},c=[{label:"嘉宾介绍",level:2},{label:"讨论内容",level:2},{label:"观看方式",level:2},{label:"特别鸣谢",level:2}],n=`<h2 id="嘉宾介绍">嘉宾介绍</h2>
<p>施继成</p>
...
<p>咨询的小伙伴，可添加小月@阅码场的微信 <strong>Linuxer2016</strong> 咨询</p>`;export{s as assetURLs,n as default,l as metadata,c as toc};
