const t="/zh-cn/assets/cover-5856255d.png",n="/zh-cn/assets/image1-a156153e.png",o="/zh-cn/assets/image2-b0a4a464.png",s="/zh-cn/assets/image3-bf4f8777.png",r="/zh-cn/assets/image-d0c27c17.png",e=[t,n,o,s,r],a={label:"2024 RISC-V中国峰会同期活动预告 l 硬件敏捷开发与验证方法学研讨会",description:"2024 RISC-V 中国峰会将于8月19日至25日在杭州黄龙饭店隆重举行。峰会采用“主会议+技术研讨会+展览展示+同期活动”的创新形式，将有超过20场同期活动在8月19日至25日期间同步进行。RISC-V 中国峰会至今已成功举办四届，现已成为中国大陆规格最高、规模最大、影响力最强的专业会议之一。作为本届RISC-V中国峰会的同期活动，8月22日上午，达坦科技将举办第三届硬件敏捷开发与验证方法学研讨会。",cover:"./cover.png",location:"新疆",date:"2024-08-16",title:"RISC V China Summit Simultaneous Event Preview l Hardware Agile Development and Verification Methodology Seminar"},g=[{label:"活动信息",level:2}],i=`<p><img src="${t}" alt="图片">
<strong>2024 RISC-V中国峰会</strong>
...
在数字化转型浪潮的推动下，数字芯片作为信息技术的核心载体，其设计与验证的复杂度与日俱增，市场竞争亦趋于白热化。面对这一挑战，如何有效提升数字芯片的开发与验证效率，成为了摆在整个行业面前的重大课题。传统基于Verilog、SystemVerilog、VHDL及UVM的设计与验证方法虽已根深蒂固，但面对新时代的需求，其局限性日益凸显。</p>
<p>近年来，一股新兴力量正悄然改变着这一现状——以Chisel、SpinalHDL为代表的新一代硬件描述语言（HDL）以及Cocotb、pyuvm等新一代验证框架的崛起，为数字芯片的设计与验证领域注入了新的活力。这些新兴技术不仅在语法表达、代码简洁性及错误检查等方面展现出显著优势，更重要的是，它们为硬件敏捷设计与验证开辟了全新的路径，为业界带来了前所未有的灵活性和效率提升。</p>
<p>为了深入探讨这一领域的最新进展，促进技术交流与创新，本次研讨会特邀来自顶尖学术机构与科研前沿的几位专家，共同分享他们在硬件敏捷设计与验证方面的实践经验与前沿思考
<img src="${n}" alt="图片"></p>
<h2 id="活动信息">活动信息</h2>
<p><strong>活动时间：</strong> 2024年8月22日，上午9:30-11:45</p>
<p><strong>活动地点</strong>：杭州黄龙饭店 珍珠厅1</p>
<p><strong>观众报名链接：</strong>
<img src="${o}" alt="图片">
<strong>第二届硬件敏捷开发与方法学研讨会 l 2023 RISC-V中国峰会同期活动顺利举办</strong>
<img src="${s}" alt="图片">
...
<img src="${r}" alt="图片"></p>`;export{e as assetURLs,i as default,a as metadata,g as toc};
