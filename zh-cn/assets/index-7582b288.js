...
<p><strong>Xline 是一个用于元数据管理的分布式 KV 存储。</strong> 以上为对 Xline 中使用的 Curp 共识协议的重构总结。</p>
