const e="/zh-cn/assets/image1-b94c1c7d.png",a="/zh-cn/assets/image2-9e714392.png",t="/zh-cn/assets/image3-71513577.png",i=[e,a,t],s={label:"一次RDMA用户态驱动调试的复盘",description:"在达坦科技实习期间，笔者开发了一个RDMA用户态驱动，用于与达坦科技自研的BlueRDMA进行交互。整个驱动分为内核态和用户态两个部分。",location:"新疆",cover:"./image1.png",author:["邱奇琛"],date:"2024-09-12",title:"A Review of Debugging a RDMA User Space Driver"},l=[{label:"背景",level:2},{label:"cache一致性的问题",level:2},{label:"从单独的模块入手",level:2},{label:"回到仿真器",level:2},{label:"番外：全0描述符的问题",level:2},{label:"对调试的反思",level:2}],r=`<p><img src="${e}" alt="图片">
