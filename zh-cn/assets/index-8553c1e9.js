const e="/zh-cn/assets/cover-6865ae02.png",l="/zh-cn/assets/image1-1421d5c3.png",t="/zh-cn/assets/image2-03115587.png",a="/zh-cn/assets/image3-8a8d1c33.png",i="/zh-cn/assets/image4-c1593056.png",p=[e,l,t,a,i],s={label:"Xline 源码解读（一） —— 初识 CURP 协议",description:"Xline 是一款开源的分布式 KV 存储引擎，其核心目的是实现高性能的跨数据中心强一致性，提供跨数据中心的meatdata 管理。那么 Xline 是怎么实现这种高性能的跨数据中心强一致性的呢？这篇文章就将带领大家一起来一探究竟。",cover:"./cover.png",location:"中国香港",author:["赵佳炜"],tags:["Xline"],date:"2023-07-13",title:"Interpretation of Xline source code (1)——Introduction to CURP protocol"},n=[{label:"Xline 是什么",level:2},{label:"Xline 的整体架构",level:2},{label:"CURP 协议简介",level:2},{label:"CURP 是什么？",level:3},{label:"为什么选择 CURP 协议",level:3},{label:"fast path 与 slow path",level:3},{label:"Summary",level:2}],r=`<p><img src="${e}" alt="封面"></p>
...
<p><a href="https://mp.weixin.qq.com/s?__biz=MzkwNTMzOTE2MA==&#x26;mid=2247484541&#x26;idx=1&#x26;sn=a7606b6f899a8fe6fddd8e9d77caa027&#x26;chksm=c0f80c0af78f851cb8699105225749da05526dfef676a244f53d7154c0f35399b30e5984f123&#x26;scene=21#wechat_redirect">DatenLord | Xline Geo-distributed KV Storage</a></p>`;export{p as assetURLs,r as default,s as metadata,n as toc};
