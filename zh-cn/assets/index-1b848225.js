const e="/zh-cn/assets/cover-ccfdc2fa.jpg",t="/zh-cn/assets/image1-9be7272d.jpg",n="/zh-cn/assets/image2-20a7bcaa.jpg",a=[e,t,n],s={label:"DatenLord X Segmentfault直播预告 | CURP协议的工业化实践",description:"传统单数据中心解决方案无法满足跨数据中心的场景对性能和一致性的需求。DatenLord推出开源的分布式KV存储Xline，针对多数据中心场景，实现数据的高性能跨云、跨数据中心共享访问，并且保证数据的一致性，方便业务系统实现多地多中心多活部署。",cover:"./cover.jpg",location:"新加坡",date:"2023-08-15",title:"DatenLord X Segmentfault Live Stream Preview l CURP Protocol in Industrial Practice"},c=[{label:"CURP 协议",level:2}],o=`<p><img src="${e}" alt="图片"></p>
...
<p><img src="${n}" alt="图片"></p>`;export{a as assetURLs,o as default,s as metadata,c as toc};
