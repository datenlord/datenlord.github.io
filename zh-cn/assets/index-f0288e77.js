const e="/zh-cn/assets/image-8a82c950.png",p="/zh-cn/assets/image2-fedcb560.png",c="/zh-cn/assets/image3-e10b812e.png",P="/zh-cn/assets/image4-97f5ce33.png",I="/zh-cn/assets/image5-518dd716.png",o="/zh-cn/assets/image6-06237b2e.png",C="/zh-cn/assets/image7-c22e37fd.png",l="/zh-cn/assets/image8-82d6772e.png",t="/zh-cn/assets/image9-9d5cd850.png",n="/zh-cn/assets/image10-20f4aa92.png",i=[e,p,c,P,I,o,C,l,t,n],b={label:"规模弹性： 管理谷歌的TPUv4机器学习超级计算机",description:"我们采用软件定义网络（SDN）方法来管理 TPUv4 的高带宽芯片间互连（ICI）结构，利用光路交换来动态配置路由，以应对机器、芯片和链路故障。我们的基础设施可检测故障并自动触发重新配置，以最大限度地减少对运行工作负载的干扰，同时启动受影响组件的补救和修复工作流程。",location:"中国香港",cover:"./image1.png",author:["达坦科技"],date:"2024-06-13",title:"Managing Google's TPUv4 Machine Learning Supercomputer"},d=[{label:"引言",level:2},{label:"可重构的 ML 超级计算机系统架构",level:2},{label:"静态 pod 架构的经验教训",level:3},{label:"TPUv4：基于 OCS 的可重构性",level:3},{label:"可编程 ICI 协议",level:3},{label:"超级计算机管理自动化",level:2},{label:"概述",level:3},{label:"超级计算机建模",level:3},{label:"集群调度",level:3},{label:"光点管理器",level:3},{label:"libtpunet",level:3},{label:"硬件维护和恢复",level:3}],T=`<p><img src="${e}" alt="图片">
...
<h4>在线 ICI 链路修复</h4>
<p>对于 TPUv4，可在线进行 ICI 链路修复，在链路两端自动协调，以便可靠地验证恢复情况。两个端点可以跨越两台不同的机器，或一台机器和一台 OCS 交换机。Pod 管理器通过 ICI 链路耗尽来协调所有 ICI 网络维护。虽然 TPU 计算资源不会受到影响（也就是说，只要不使用损坏的 ICI，作业仍可在 TPU 机器上执行），但 ICI 链接耗尽时，用户应用程序将自动被排除在外。</p>`;export{i as assetURLs,T as default,b as metadata,d as toc};
