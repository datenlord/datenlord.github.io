const e="/zh-cn/assets/image1-c4dd53d1.png",p="/zh-cn/assets/image2-fa66fb73.png",r="/zh-cn/assets/image3-8880c3cc.png",a="/zh-cn/assets/image4-b570d690.png",n="/zh-cn/assets/image5-8de7d7ee.png",d="/zh-cn/assets/image6-a0e12934.png",t="/zh-cn/assets/image7-98cf4bc1.png",l=[e,p,r,a,n,d,t],i={label:"blue-rdma 设计介绍 （一）—— 如何实现RDMA操作",description:"blue-rdma是一个新的RDMA实现。本文将介绍blue-rdma是如何实现常见的几种RDMA操作的，并且我们会分析blue-rdma设计和InfiniBand的异同点。",location:"中国香港",cover:"./image1.png",author:["尹正皓"],date:"2025-04-24",title:"Introduction to Blue RDMA Design (I)–How to Implement RDMA Operations"},R=[{label:"RDMA 操作类型",level:2},{label:"blue-rdma和InfiniBand的设计区别",level:2},{label:"blue-rdma驱动和硬件的消息传递",level:2},{label:"RDMA WRITE 操作",level:2},{label:"RDMA SEND/RECV 操作",level:2},{label:"RDMA READ 操作",level:2},{label:"总结",level:2},{label:"关于作者",level:2}],s=`<p><img src="${e}" alt="图片"></p>
