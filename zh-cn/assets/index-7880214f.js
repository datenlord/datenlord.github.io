const s="/zh-cn/assets/cover-23656e2c.png",t="/zh-cn/assets/image1-e7f8d041.png",n="/zh-cn/assets/image2-bf4f8777.png",o="/zh-cn/assets/image-d0c27c17.png",e=[s,t,n,o],a={label:"达坦科技率先落地基于海光的DeepSeek一体机",description:"达坦科技率先落地基于海光 DCU 的 DeepSeek 一体机，分为轻量版、标准版和高级版。高级版包含8张海光 DCU，支持 DeepSeek V3/R1 满血版。缓存优化、RDMA 传输优化，提高大模型的性能，降低推理和训练成本。",cover:"./cover.png",location:"中国香港",date:"2025-02-21",title:"DartanLord Leads the Deployment of DeepSeek All in One Machine Based on Hygon"},r=[],c=`<p><img src="${t}" alt="图片"></p>
<p><img src="${n}" alt="图片">
...
<img src="${o}" alt="图片"></p>`;export{e as assetURLs,c as default,a as metadata,r as toc};
