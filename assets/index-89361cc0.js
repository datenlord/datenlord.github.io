const i="/assets/cover-6865ae02.png",l=[i],t={label:"Xline v0.5.0 一个用于元数据管理的分布式KV存储",description:"Xline是一个基于Curp协议的，用于管理元数据的分布式KV存储。现有的分布式KV存储大多采用Raft共识协议，需要两次RTT才能完成一次请求。当部署在单个数据中心时，节点之间的延迟较低，因此不会对性能产生大的影响。",cover:"./cover.png",location:"新加坡",author:["达坦科技"],tags:["Xline"],date:"2023-08-15",title:"Xline v0.5.0 a distributed KV store for metadata management"},e=[{label:"Xline是什么？我们为什么要做Xline？",level:2},{label:"V0.5.0版本有什么新功能？",level:2}],n=`<p><img src="${i}" alt="图片"></p>
...
<ul>
<li>@liubog2008</li>
</ul>`;export{l as assetURLs,n as default,t as metadata,e as toc};
