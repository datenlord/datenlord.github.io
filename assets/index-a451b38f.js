const s="/assets/image1-85650830.png",a="/assets/image2-d3ac686f.png",t="/assets/image3-d19685f7.png",e="/assets/image4-22c90bed.png",l="/assets/image5-060ec542.png",p="/assets/image6-e95accb5.png",i="/assets/image7-39b0aa47.png",n="/assets/image8-f5342e9f.png",c="/assets/image9-f8fdd108.png",r="/assets/image10-fea0520f.png",C="/assets/image11-3896bab5.png",o="/assets/image12-5d3c96d7.png",d="/assets/image13-56596c1a.png",h="/assets/image14-1cff1399.png",u="/assets/image15-f50d9208.png",m="/assets/image16-73064f95.png",g="/assets/image17-8fbf2614.png",R="/assets/image18-04a62cf7.png",_="/assets/image19-b4bc01e2.png",b="/assets/image20-41386794.png",j="/assets/image21-453c426e.png",E="/assets/image22-e0049342.png",S="/assets/image23-989a38cf.png",f=[s,a,t,e,l,p,i,n,c,r,C,o,d,h,u,m,g,R,_,b,j,E,S],y={label:"基于BSV的高性能并行CRC硬件电路生成器",description:"循环冗余校验码，即Cyclic Redundancy Check (CRC), 是一种在各种通信系统中广泛应用的检错机制。CRC算法的工作原理和哈希函数类似，具体来说，其对任意长度的数据计算出一段唯一的标识（校验和）, 然后根据这个标识来判断该数据在传输过程中是否发生变化。CRC检错码在实际生活中有着广泛的应用，诸如网络通信，存储系统等场景下都需要CRC来保证数据传输的正确性。而不同的应用场景往往需要采用不同的CRC配置参数，同时对计算的性能也有不同的需求。例如，在基于Ethernet协议的网络传输中需要采用IEEE802-3协议所规定的CRC参数，同时需要高吞吐率的CRC实现以和网络带宽相匹配。",location:"中国香港",author:["翁万正"],tags:["硬件加速"],date:"2023-07-27",title:"BSV based high performance parallel CRC hardware circuit generator"},x=[{label:"引 言",level:2},{label:"算法原理",level:2},{label:"CRC 计算的定义",level:3},{label:"电路架构与性能",level:2},{label:"架构设计",level:3},{label:"性能与面积",level:3},{label:"使用指南",level:2},{label:"配置参数",level:3},{label:"输入输出接口",level:3},{label:"BSV 使用接口",level:3},{label:"Verilog 使用接口",level:3},{label:"引用和链接",level:2}],F=`<h2 id="引-言">引 言</h2>
...
<p>[2] Sun Y, Kim M S. A pipelined CRC calculation using lookup tables[C]//2010 7th IEEE Consumer Communications and Networking Conference. IEEE, 2010: 1-2.</p>`;export{f as assetURLs,F as default,y as metadata,x as toc};
