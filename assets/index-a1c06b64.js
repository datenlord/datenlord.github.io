const e="/assets/cover-a5e280f4.jpg",l="/assets/image1-ebdad1b1.png",t=[e,l],i={label:"首个跨云元数据KV存储Xline正式进入CNCF沙箱",description:"Xline 是一款开源的分布式 KV 存储引擎，其核心目的是实现高性能的跨数据中心强一致性，提供跨数据中心的meatdata 管理。那么 Xline 是怎么实现这种高性能的跨数据中心强一致性的呢？这篇文章就将带领大家一起来一探究竟。",cover:"./cover.jpg",location:"中国香港",author:["达坦科技"],tags:["Xline"],date:"2023-06-21",title:"The first cross cloud metadata KV storage Xline officially entered the CNCF sandbox"},r=[{label:"Birth Xline 的诞生",level:2},{label:"Feature Xline 的特点",level:2},{label:"Core Curp 共识协议",level:2},{label:"Growth 版本持续迭代",level:2},{label:"Together We Grow!",level:2}],n=`<p><img src="${e}" alt="封面"></p>
...
</ul>`;export{t as assetURLs,n as default,i as metadata,r as toc};
