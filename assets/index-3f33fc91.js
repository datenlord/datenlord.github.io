const e="/assets/image1-5ce6797d.png",t="/assets/image2-62bec92b.png",a=[e,t],r={label:"用async_rdma库加速 Datenlord KVCache 模块",description:"本文讨论了如何利用 RDMA 技术加速 Datenlord 分布式 KVCache 模块。当前的 KVCache 模块使用 TCP 进行数据传输，这会消耗大量 CPU 资源。通过引入 RDMA 技术，建立零拷贝传输通道，消除不必要的内存拷贝并节省 CPU 资源，节省了 KVCache 模块的开销，提高了整个系统的效率。具体来讲，本文详细描述了如何设计和实现一套混合传输方案，并使用 Datenlord 开发的 async_rdma 库完成这套方案，从原理到实践指导开发者开发一个实用的 RDMA 应用。",location:"中国香港",cover:"./image1.png",author:["陈添"],date:"2025-03-05",title:"Accelerating the Datenlord KVCache Module with the Async_rdma Library"},c=[{label:"引言",level:2},{label:"背景知识",level:2},{label:"方案设计",level:2},{label:"基础代码设计",level:2},{label:"性能优化实践",level:2},{label:"未来展望",level:2},{label:"总结",level:2}],l=`<p><img src="${e}" alt="图片"></p>
<h2 id="引言">引言</h2>
