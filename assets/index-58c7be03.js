const e="/assets/cover-1329fc54.png",l="/assets/image1-03c3323d.png",s="/assets/image2-19f32eff.png",i="/assets/image3-7a5e2db9.png",a="/assets/image4-a055bd84.png",t="/assets/image5-b8622f96.png",p="/assets/image6-5093ee75.png",n="/assets/image7-9fa09d91.png",o="/assets/image8-84dd6aec.png",c="/assets/image9-2f762488.png",r="/assets/image10-f2b55246.png",d="/assets/image11-c5d501bb.png",h="/assets/image12-56434254.png",m="/assets/image13-1c12a6c5.png",u="/assets/image14-69943dbe.png",b="/assets/image15-45a7b638.png",g="/assets/image16-5b765721.jpg",f="/assets/image17-8fb19d7c.jpg",R="/assets/image18-c8c4d5a1.jpg",y="/assets/image19-fb1e5167.png",_="/assets/image20-a391e7d8.jpg",S=[e,l,s,i,a,t,p,n,o,c,r,d,h,m,u,b,g,f,R,y,_],M={label:"计算机体系结构｜MIT6.175和MIT6.375学习笔记",description:"在2023年初，达坦科技发起成立硬件设计学习社区，邀请所有有志于从事数字芯片设计的同学加入我们的学习互助自学小组，以理解数字芯片设计的精髓，强化理论知识的同时提升实操技能，继而整体提升设计能力。现在，完成第一期学习的同学整理了MIT6.175和MIT6.375的关键内容以及Lab实践的学习笔记。",cover:"./cover.png",location:"中国香港",author:["kazutoiris"],tags:["硬件加速"],date:"2023-05-17",title:"Computer Architecture｜MIT6.175 and MIT6.375 Study Notes"},v=[{label:"MIT 6.175",level:2},{label:"环境搭建",level:3},{label:"四种 FIFO (Lab 4)",level:3},{label:"Ready 和 Valid 握手",level:3},{label:"EHR 寄存器 (Lab4)",level:3},{label:"RISC-V (Lab5)",level:3},{label:"Branch Prediction (Lab6)",level:3},{label:"DDR3 Memory (Lab7)",level:3},{label:"Cache Coherence (Project)",level:3},{label:"MIT 6.375",level:2},{label:"Bluespec 中的一些特性",level:3},{label:"CORDIC 算法",level:3},{label:"一些常用的概念",level:2},{label:"Setup Time 、Hold Time 和 Clock-to-Q Time",level:3},{label:"SRAM",level:3},{label:"DRAM",level:3},{label:"References",level:2}],C=`<p><img src="${e}" alt="图片"></p>
...
<p><img src="${_}" alt="图片"></p>`;export{S as assetURLs,C as default,M as metadata,v as toc};
