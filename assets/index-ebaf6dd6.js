const e="/assets/cover-c17c52cc.png",s="/assets/image1-0dff4570.png",c="/assets/image2-e09cfdc8.png",o="/assets/image3-2b589463.png",p="/assets/image4-5841c9d6.png",a="/assets/image5-92344f1d.png",d="/assets/image6-b429f851.png",r="/assets/image7-97920b5a.png",i="/assets/image8-ecf5c6f3.png",t="/assets/image9-f47bad66.png",l="/assets/image10-b50adc27.png",n="/assets/image11-99ec2a51.png",m=[e,s,c,o,p,a,d,r,i,t,l,n],g={label:"从数学角度思考程序与验证正确性",description:"本文旨在为没有接触过形式化方法的读者提供一种新的视角看待计算机系统与算法，而非形式化方法或 TLA+ 教程。因此本文的重点是如何从数学角度思考程序，不会使用大篇幅讲解 TLA+ 的语法。",cover:"./cover.png",location:"中国香港",author:["田野"],tags:["Xline"],date:"2023-03-02",title:"Thinking about programs mathematically and verifying correctness"},h=[{label:"我们该如何写出正确的程序？",level:2},{label:"程序中会有什么样错误？",level:3},{label:"经验",level:3},{label:"形式化方法",level:3},{label:"TLA+",level:2},{label:"简单的例子",level:3},{label:"Two-Phase Commit",level:2},{label:"总结",level:2},{label:"我们的项目：Xline",level:2}],A=`<p><img src="${e}" alt="封面"></p>
