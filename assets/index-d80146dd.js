const l="/assets/cover-eeda38bf.png",i=[l],t={label:"Xline v0.6.0:一个用于元数据管理的分布式KV存储",description:"Xline是一个基于Curp协议的，用于管理元数据的分布式KV存储。现有的分布式KV存储大多采用Raft共识协议，需要两次RTT才能完成一次请求。当部署在单个数据中心时，节点之间的延迟较低，因此不会对性能产生大的影响。但是，当跨数据中心部署时，节点之间的延迟可能是几十或几百毫秒，此时 Raft 协议将成为性能瓶颈。Curp 协议就是为了解决这个问题而设计的。它可以在命令不冲突的情况下减少一个RTT，从而提高性能。因此，Xline旨在实现高性能的数据访问和跨数据中心场景下的强一致性。",cover:"./cover.png",location:"中国香港",author:["更新版本的"],tags:["Xline"],date:"2023-11-23",title:"Xline v0.6.0_ a distributed KV store for metadata management"},e=[{label:"Xline 是什么？我们为什么要做 Xline？",level:2},{label:"V0.6.0 版本有什么新功能？",level:2}],n=`<p><img src="${l}" alt="封面"></p>
