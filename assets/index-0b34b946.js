const p="/assets/cover-b2241eaf.png",e=[p],t={label:"Xline v0.7.0： 一个用于元数据管理的分布式KV存储",description:"Xline是一个基于Curp协议的，用于管理元数据的分布式KV存储。Curp 协议可以在命令不冲突的情况下减少一个RTT，从而提高性能。Xline旨在实现高性能的数据访问和跨数据中心场景下的强一致性。",location:"新疆",cover:"./image.png",author:["达坦科技"],date:"2024-08-29",title:"Xline v 0.7.0   A Distributed KV Store for Metadata Management"},a=[],o=`<p><img src="${p}" alt="图片">
