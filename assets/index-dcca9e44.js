const e="/assets/cover-4e3a952e.webp",a="/assets/image1-d5c7d3eb.webp",l="/assets/image2-4eebd69c.webp",r="/assets/image3-11daa3fe.webp",i="/assets/image4-30403828.webp",t="/assets/image5-7c696faa.webp",m="/assets/image6-a778303e.webp",s="/assets/image7-ba335a80.webp",o="/assets/image8-6a8e4dea.webp",p="/assets/image9-9202db97.webp",n=[e,a,l,r,i,t,m,s,o,p],c={label:"Karmada 管理有状态应用 Xline 的早期探索与实践",description:"目前随着云原生技术和云市场的不断成熟，越来越多的 IT 厂商开始投入到跨云多集群的怀抱当中。以下是 flexera 在 2023 年中关于云原生市场对多云多集群管理的接受程度的调查报告（info.flexera.com）",cover:"./cover.webp",location:"中国香港",author:["赵佳炜"],date:"2024-03-21",title:"Early Explorations and Practices of Xline a Stateful Application Managed by Karmada"},d=[{label:"背景与动机",level:2},{label:"Karmada 管理有状态应用存在哪些挑战？",level:2},{label:"Xline 的一些早期尝试",level:2},{label:"部署",level:3},{label:"扩缩容",level:3},{label:"滚动更新",level:3},{label:"总结",level:2},{label:"Xline 社区会议",level:2}],b=`<p><img src="${e}" alt="封面"></p>
...
<a href="https://zoom.us/j/81305478985?pwd=PsnbMGQy1ZqxYyd67cAkaGROfnIoQa.1">https://zoom.us/j/81305478985?pwd=PsnbMGQy1ZqxYyd67cAkaGROfnIoQa.1</a></p>`;export{n as assetURLs,b as default,c as metadata,d as toc};
