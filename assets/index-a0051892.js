const v="/assets/cover-92745c95.jpg",e="/assets/image1-638abd39.png",s="/assets/image2-2a8f796e.gif",p="/assets/image3-ae1841b7.png",a="/assets/image4-5bf432ec.png",n="/assets/image5-81eb5b8d.png",l="/assets/image6-537c8738.png",o="/assets/image7-b58de99e.png",i="/assets/image8-c6334c83.png",t="/assets/image9-6340ddaa.png",c="/assets/image10-ac1b70de.png",r="/assets/image11-1f1870d2.png",_="/assets/image12-01c249ea.png",m="/assets/image13-a48112ad.png",u="/assets/image14-d780d4f2.png",d="/assets/image15-f58a4d86.png",h="/assets/image16-79c3985b.png",k="/assets/image17-863e7adb.png",f="/assets/image18-931263d9.png",g="/assets/image19-8f35c101.png",b="/assets/image20-ef5a452f.png",P="/assets/image21-ebff1568.png",j="/assets/image22-b3b3dbaa.png",F="/assets/image23-12fff2c5.png",w=[v,e,s,p,a,n,l,o,i,t,c,r,_,m,u,d,h,k,f,g,b,P,j,F],T={label:"数据流式编程在硬件设计中的应用",description:"数据流式编程（Dataflow Programming）是一种存在已久的程序设计范式，可以追溯到19世纪60年代，由MIT的Jack Dennis教授开创。",cover:"./cover.jpg",location:"中国香港",author:["米明恒"],tags:["硬件加速"],date:"2023-10-26",title:"Application of data flow programming in hardware design"},C=[{label:"数据流式编程的思想",level:2},{label:"数据流式编程思想简介",level:3},{label:"软件开发中的数据流式编程思想",level:3},{label:"软件数据流 vs 硬件数据流",level:3},{label:"数据流思想与状态机思想的对比",level:3},{label:"Bluespec 语言及其流式编程框架 PAClib",level:2},{label:"Bluespec SystemVerilog(BSV)和 PAClib 简介",level:3},{label:"PAClib 中的基础开发组件",level:3},{label:"IFFT 应用实例",level:2},{label:"需求背景",level:3},{label:"代码实现",level:3},{label:"写在最后",level:2}],I=`<h2 id="数据流式编程的思想">数据流式编程的思想</h2>
...
<p><a href="http://www.cs.ox.ac.uk/ralf.hinze/WG2.8/27/slides/rishiyur2.pdf">http://www.cs.ox.ac.uk/ralf.hinze/WG2.8/27/slides/rishiyur2.pdf</a>.</p>`;export{w as assetURLs,I as default,T as metadata,C as toc};
