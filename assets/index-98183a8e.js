const h="/assets/cover-5066a289.png",e="/assets/image-aa4a4978.png",p="/assets/image1-ee6de1d9.png",t="/assets/image2-ef6d7b9c.png",r="/assets/image3-609bf8da.png",a="/assets/image4-83dbad26.png",o="/assets/image5-95757064.png",i="/assets/image6-8fa0a664.png",n="/assets/image7-4907a13a.png",c="/assets/image8-a3f22a09.png",l="/assets/image1-bf4f8777.png",s="/assets/image-d0c27c17.png",d=[h,e,p,t,r,a,o,i,n,c,l,s],f={label:"Xinference & DatenLord: 探索异构环境下DeepSeek R1大模型分离式推理的最佳实践",description:"本篇文章详细探讨了大语言模型推理效率提升的核心技术，特别是KVCache技术及其在异构环境下的应用。在分析了现有技术瓶颈的基础上，Xinference提出了通过分离式推理架构以及优化缓存技术来解决这些问题的方法。Xinference与DatenLord的设计方案展示了在分布式环境中提升推理性能的可行性，尤其是在高效利用推理引擎和跨节点KVCache共享方面取得的显著进展。",cover:"./cover.png",location:"中国香港",date:"2025-03-21",title:"Xinference & DatenLord Exploring Best Practices for Disaggregated Inference of DeepSeek R1 Large Model in Heterogeneous Environments"},g=[{label:"引言",level:2},{label:"背景知识",level:2},{label:"现有瓶颈",level:2},{label:"Xinference设计方案",level:2},{label:"结论",level:2}],D=`<h2 id="引言">引言</h2>
